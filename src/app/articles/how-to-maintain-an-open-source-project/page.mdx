...
export const article = {
 ...
 date: '2016-01-30',
 published: true,
 title: "How to Maintain an Open Source Project Without Losing Your Mind",
 description: "A response to Eran Hammer on maintainer burnout. Entitlement in open source is real, but public shaming makes a bad situation worse.",
}

export const metadata = {
 title: article.title,
 description: article.description,
 openGraph: { title: article.title, description: article.description, url: '/articles/how-to-maintain-an-open-source-project' },
...
In the end I agree with Eran and I still respect him as an engineer. He has written some awesome code. I hope I’ve added some support to his **very valid** argument. Just maybe next time we can skip the pile-on?
